"""ワンオフスクリプト（2026/08/02 更新）

2026/08/02、戸井さんのCPaSSセッションでDHLボタン検出バグ①・単位重量0バグ②の
調査中に、25-14943-96732の配送業者としてDHL（7,969円）を実際に割り当て・保存
済みだったため、この確定価格を売上管理表(Google Drive上のxlsm)のBL列（通常）に
書き込む。
